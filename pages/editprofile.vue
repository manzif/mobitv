              ...
              <v-card text class="pa-10">
                ...
                >
                  <v-layout row wrap class="pa-5">
                    ...
                    <v-flex xs12 md6>
                      <div class="subtitle-1 grey--text pb-1">Username</div>
                      <v-text-field
                        v-model="username"
                        dense
                        single-line
                    ...
                    <v-flex xs12 md6>
                      <div class="subtitle-1 grey--text pb-1">Password</div>
                      <v-text-field
                        v-model="password"
                        dense
                        single-line
                    ...
                    <v-flex xs12 md6>
                      <div class="subtitle-1 grey--text pb-1">CallBack Url</div>
                      <v-text-field
                        v-model="callback"
                        dense
                        single-line
...
.line {
  width: 50px;
  border-bottom: 3px solid #98989d;
  position: absolute;
}
</style>
